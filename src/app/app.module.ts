...
import {faEnvelope, faSmileBeam, faSmileWink, faBookmark} from '@fortawesome/free-regular-svg-icons';
...
export class AppModule {
  constructor() {
    library.add(faSmileWink, faSmileBeam, faFacebookF, faTwitter, faLinkedinIn, faInstagram, faGithub, faMapMarkerAlt, faGlobe, faEnvelope, faPhone, faBookmark);
  }
}
